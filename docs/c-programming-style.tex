...
Comments shall normally use //, with one // on each commented line.
/* ... */ shall normally not be used. Larger comment blocks may be
delimited by lines consisting of // followed by 70 hyphens.
...
And for start of larger block there should be 70 hyphens like
